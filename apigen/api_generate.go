...
func GenerateAPI(ctx context.Context, clientOutput, eventsOutput io.Writer) error {
	...
	eventsImports["github.com/dotabook/go-dota2/protocol"] = struct{}{}
	eventsImports["google.golang.org/protobuf/proto"] = struct{}{}

	clientImports := make(map[string]struct{})
	clientImports["context"] = struct{}{}
	clientImports["github.com/dotabook/go-dota2/protocol"] = struct{}{}
	clientImports["github.com/dotabook/go-steam/steamid"] = struct{}{}
	clientImports["github.com/dotabook/go-dota2/events"] = struct{}{}
			...
			for i := 0; i < reqDs.NumFields(); i++ {
				...
				if !isSlice &&
					...
					reqFieldType = types.NewNamed(
						types.NewTypeName(
							0,
							packageMap["github.com/dotabook/go-steam/steamid"],
							"SteamId",
							reqFieldType,
						),
						reqFieldType,
